...
//  CubeImageLoader
//
//  Created by denglei on 2019/6/4.
//  Copyright © 2019年 soudian. All rights reserved.
//
...
-(void)commonInit{
    ...
    //4.将GLKView 添加到self.view上
    [self.view addSubview:self.glkView];
    
    //5.获取纹理图片
    NSString * imagePath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"beauty.jpeg"];
...
-(void)vertexDataSetup{
    ...
    //开辟缓存区 VBO vertex buffer object
