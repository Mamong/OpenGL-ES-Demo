...
-(void)render{
    ...
    GLuint postionColor = glGetAttribLocation(self.myPrograme, "positionColor");
    ...
    //参数5：stride,连续顶点属性之间的偏移量，默认为0；
    //参数6：指定一个指针，指向数组中的第一个顶点属性的第一个组件。默认为0
    glVertexAttribPointer(postionColor, 3, GL_FLOAT, GL_FALSE, sizeof(GLfloat)*6, (float *)NULL +3 );
