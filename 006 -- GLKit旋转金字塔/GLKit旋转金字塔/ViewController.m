...
//  GLKit旋转金字塔
//
//  Created by denglei on 2019/6/15.
...
-(void)render
{
    ...
    NSDictionary *dicr = [NSDictionary dictionaryWithObjectsAndKeys:@"1",GLKTextureLoaderOriginBottomLeft,nil];
    GLKTextureInfo * textureInfo = [GLKTextureLoader textureWithContentsOfFile:filePath options:dicr error:nil];
