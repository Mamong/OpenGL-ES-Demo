...
void SetupRC()
{
    ...
    gltMakeCylinder(coneBatch, 0.0f, 2.0f, 3.0f, 15, 2);
...
void RenderScene(void)
{
    ...
    //参数3：颜色
    shaderManager.UseStockShader(GLT_SHADER_FLAT,transformPipeline.GetModelViewMatrix(),transformPipeline.GetProjectionMatrix(),vBlack);
