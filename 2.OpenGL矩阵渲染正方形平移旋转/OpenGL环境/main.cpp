...
void RenderScene(void)
{
    ...
    //设置一组浮点数来表示红色
    GLfloat vRed[] = {0.0,0.0,1.0,1.0f};
    
    //x,y,z,w(缩放因子)
    M3DMatrix44f mTransformMatrix, mRotateMatrix, mFinalMatrix;
    ...
    //旋转矩阵赋值
    m3dRotationMatrix44(mRotateMatrix, m3dDegToRad(ZRot), 0.0f, 0.0f, 1.0f);
      ZRot += 5.0f;
    //矩阵相乘
    m3dMatrixMultiply44(mFinalMatrix, mTransformMatrix, mRotateMatrix);
